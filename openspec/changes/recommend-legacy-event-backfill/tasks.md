...
- [x] 1.1 Create or switch to a clean worktree from updated `origin/main` that includes merged PR #361 before editing any files.
- [x] 1.2 Confirm the target OpenSpec artifacts are present: `proposal.md`, `specs/legacy-event-backfill-recommendation/spec.md`, and `design.md`.
