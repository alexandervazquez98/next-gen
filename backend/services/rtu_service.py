"""RTU/Sensor Service — business logic layer above the repository.
...
def compute_mqtt_topic(location_id: UUID, rtu_id: UUID) -> str:
    ...
    This is deterministic — same location_id + rtu_id always produces the same topic.
    """
...
class RTUService:
    ...
    # ── MQTT Subscriber helpers (get-or-create semantics) ─────────────────────
